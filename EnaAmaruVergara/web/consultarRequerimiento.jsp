<%-- 
    ...
    Created on : 22/07/2020, 02:39:19 PM
    Author     : amaru
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container mt-6">
            <h2 class="title is-2">Consultar Requerimiento</h2>
            <br />
            <form action="consultarRequerimiento.jsp" method="get">
                <div class="field">
            ...
            <table class="table is-fullwidth">
                ...
                <tr> 
                    ...
                    <td><%= r.isEstado()? "Cerrado":"Abierto" %></td>
                </tr>
